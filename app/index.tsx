...
const styles = StyleSheet.create({
  ...
  cardPlateMainDesktop: { gap: 19, paddingHorizontal: 8 },
  ...
  cardPlateDigitsDesktop: { fontSize: 88 },
  ...
  detailsPlateMain: { alignItems: "center", flex: 1, flexDirection: "row", gap: 19, justifyContent: "center", minWidth: 0, paddingHorizontal: 8 },
  detailsPlateLetter: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 82, fontWeight: "700", letterSpacing: -2.2, textAlign: "center" },
  detailsPlateDigits: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 94, fontWeight: "700", letterSpacing: -2.2, paddingHorizontal: 0, textAlign: "center" },
  detailsPlateLetters: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 82, fontWeight: "700", letterSpacing: -2.2, paddingHorizontal: 0, textAlign: "center" },
