...
const styles = StyleSheet.create({
  ...
  // Масштаб как на предоставленном фото: 570 × 123 при реальной пропорции 4,63:1.
  cardPlateDesktop: { flexBasis: 570, flexGrow: 0, flexShrink: 1, height: 123, maxWidth: "62%", width: 570 },
  ...
  cardPlateLetterDesktop: { fontSize: 78, left: "4%", position: "absolute", top: 12, width: "18%" },
  ...
  cardPlateDigitsDesktop: { fontSize: 108, left: "19%", position: "absolute", top: -3, width: "42%" },
  ...
  cardPlateLettersDesktop: { fontSize: 78, left: "59%", position: "absolute", top: 12, width: "31%" },
  ...
  cardPlateRegionDesktop: { width: 132 },
  ...
  cardPlateRegionValueDesktop: { fontSize: 59, lineHeight: 62 },
  ...
  // В полном просмотре — тот же масштаб 570 × 123.
  detailsPlatePreview: { alignSelf: "center", backgroundColor: "#FFFFFF", borderColor: "#1D2939", borderRadius: 8, borderWidth: 3, flexDirection: "row", height: 123, marginTop: 20, maxWidth: "100%", overflow: "hidden", width: 570 },
  ...
  detailsPlateLetter: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 78, fontWeight: "700", left: "4%", letterSpacing: -2.2, position: "absolute", textAlign: "center", top: 11, width: "18%" },
  detailsPlateDigits: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 110, fontWeight: "700", left: "19%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: -5, width: "42%" },
  detailsPlateLetters: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 78, fontWeight: "700", left: "59%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: 11, width: "31%" },
  detailsPlateRegionBox: { alignItems: "center", borderLeftColor: "#1D2939", borderLeftWidth: 2, justifyContent: "center", paddingHorizontal: 8, width: 132 },
  detailsPlateRegionValue: { color: "#111827", fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 59, fontWeight: "700", letterSpacing: -1, lineHeight: 62 },
