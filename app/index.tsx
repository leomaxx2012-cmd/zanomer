...
const styles = StyleSheet.create({
  ...
  cardPlateLetterDesktop: { fontSize: 76, left: "4%", position: "absolute", top: 8, width: "20%" },
  ...
  cardPlateDigitsDesktop: { fontSize: 88, left: "27%", position: "absolute", top: 1, width: "36%" },
  ...
  cardPlateLettersDesktop: { fontSize: 76, left: "68%", position: "absolute", top: 8, width: "28%" },
  ...
  detailsPlateLetter: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 82, fontWeight: "700", left: "4%", letterSpacing: -2.2, position: "absolute", textAlign: "center", top: 5, width: "20%" },
  detailsPlateDigits: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 94, fontWeight: "700", left: "27%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: -2, width: "36%" },
  detailsPlateLetters: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 82, fontWeight: "700", left: "68%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: 5, width: "28%" },
