...
const styles = StyleSheet.create({
  ...
  cardPlateLetterDesktop: { fontSize: 83, left: "4%", position: "absolute", top: 9, width: "20%" },
  ...
  cardPlateDigitsDesktop: { fontSize: 96, left: "23%", position: "absolute", top: 1, width: "39%" },
  ...
  cardPlateLettersDesktop: { fontSize: 83, left: "62%", position: "absolute", top: 9, width: "30%" },
  ...
  detailsPlateLetter: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 83, fontWeight: "700", left: "4%", letterSpacing: -2.2, position: "absolute", textAlign: "center", top: 7, width: "20%" },
  detailsPlateDigits: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 98, fontWeight: "700", left: "23%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: -2, width: "39%" },
  detailsPlateLetters: { color: "#111827", flex: 0, fontFamily: Platform.select({ web: "Arial Narrow", default: "System" }), fontSize: 83, fontWeight: "700", left: "62%", letterSpacing: -2.2, paddingHorizontal: 0, position: "absolute", textAlign: "center", top: 7, width: "30%" },
